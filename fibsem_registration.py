...
sys.path.append("/lmb/home/mclayton/scripts/python/imagej/IsoView-GCaMP/")
...
startIndex = filepaths.index("/net/fibserver1/raw/Leonardo/Merlin-FIBdeSEMAna_22-12-07_020549_0-0-0.dat")
...
x0 = int(11667/2) # X coordinate of the first pixel to show
y0 = int(11250/2) # Y coordinate of the first pixel to show
